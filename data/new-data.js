const upgrade = [
    {
        ...
        reason: "Compilation of Python within a Juypter Notebook for learning and practice writing scripts.", 
        technologies: "Python",
        deployed: "",
    ...
    },
    {
        ...
        reason: "A demo created that showcases call, bind, apply and the this keyword.", 
    ...
    },
    {
        ...
        author: "Kit Fenrir Amreik (they/she)",
        audience: "students, self-learning and development",
        reason: "This is a fun demo based in Javascript with functions.", 
        technologies: "Javascript",
        deployed: "",
    ...
    {
        id: 9,
        title: "Wesley Toma Test Site",
        author: "Kit Fenrir Amreik (they/she)",
        audience: "specific client",
        reason: "This is a post grad design project for a client, which allowed me to gain some freelance experience right after I graduated in 2022. The client ended up using a snippet of my code in his website located here: https://wesleytoma.com/", 
        technologies: "HTML/CSS, Javascript",
        deployed: "",
